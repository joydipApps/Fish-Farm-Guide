...
class HomeBookMarkPage extends ConsumerStatefulWidget {
  const HomeBookMarkPage({super.key});

  @override
  ConsumerState<HomeBookMarkPage> createState() => _HomeBookIndexState();
}

class _HomeBookIndexState extends ConsumerState<HomeBookMarkPage> {
      ...
      child: Scaffold(
        body: GroupedListView<BookIndexModel, String>(
          ...
          itemBuilder: (context, element) {
            final isBookmarked =
                ref.watch(bookmarkStateProvider).contains(element.bookId);
            if (isBookmarked) {
              return Visibility(
